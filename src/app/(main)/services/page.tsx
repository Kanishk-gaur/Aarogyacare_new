...
const cancerTreatments = [
  { name: "Breast Cancer Treatment", icon: Heart, color: "from-pink-500 to-rose-600" },
  { name: "Cervical Cancer Treatment", icon: Shield, color: "from-purple-500 to-pink-600" },
  { name: "Stomach Cancer Treatment", icon: Pill, color: "from-blue-500 to-indigo-600" },
  { name: "Lung Cancer Treatment", icon: Activity, color: "from-cyan-500 to-blue-600" },
  { name: "Ovarian Cancer Treatment", icon: Target, color: "from-violet-500 to-purple-600" },
  { name: "Pancreatic Cancer Treatment", icon: Microscope, color: "from-orange-500 to-red-600" },
  { name: "Rectal Cancer Treatment", icon: Syringe, color: "from-green-500 to-emerald-600" },
]
      ...
      <section className="py-20 relative">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">{t("services.specialties.subtitle")}</p>
          </motion.div>
                ...
                <Card className="h-full overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-500 bg-white/80 backdrop-blur-sm">
                  ...
                  <CardContent className="p-6 relative">
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-xs text-gray-500">{t("services.successRate")}: 85%+</p>
                    </div>
                  </CardContent>
                </Card>
              </motion.div>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">{t("services.cancer.subtitle")}</p>
          </motion.div>
                  ...
                  <CardContent className="p-8 relative z-10">
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center mt-2">
                          ...
                          <span className="text-sm text-gray-500 ml-2">{t("services.excellenceRating")}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600">{t("services.treatmentSuccess")}</span>
